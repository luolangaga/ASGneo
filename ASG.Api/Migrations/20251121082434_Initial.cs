        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDirect = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    GameRank = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CustomField1 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CustomField2 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CustomField3 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CustomTextArea = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CustomNumber = table.Column<int>(type: "integer", nullable: true),
                    CustomDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CustomBoolean = table.Column<bool>(type: "boolean", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NeteaseHeroes", x => x.HeroId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentTaskMatches", x => new { x.TaskId, x.MatchId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QqNumber = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekNum = table.Column<int>(type: "integer", nullable: true),
                    WinRate = table.Column<double>(type: "double precision", nullable: false),
                    PingRate = table.Column<double>(type: "double precision", nullable: false),
                    UseRate = table.Column<double>(type: "double precision", nullable: false),
                    BanRate = table.Column<double>(type: "double precision", nullable: false),
                    RunRate = table.Column<double>(type: "double precision", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NeteaseHeroStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NeteaseHeroStats_NeteaseHeroes_HeroId",
                        column: x => x.HeroId,
                        principalTable: "NeteaseHeroes",
                        principalColumn: "HeroId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NeteaseHeroStats_NeteaseHeroes_HeroId1",
                        column: x => x.HeroId1,
                        principalTable: "NeteaseHeroes",
                        principalColumn: "HeroId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetitionStartTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Teams_ChampionTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    GameId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    GameRank = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailCredits = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    TeamId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiveLink = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CustomData = table.Column<string>(type: "text", nullable: false, defaultValue: "{}"),
                    Commentator = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Director = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Referee = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayPerMatch = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecruitmentTasks_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAdmins", x => new { x.EventId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecruitmentApplications_RecruitmentTasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "RecruitmentTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NeteaseHeroStats_HeroId",
                table: "NeteaseHeroStats",
                column: "HeroId");

            migrationBuilder.CreateIndex(
                name: "IX_NeteaseHeroStats_HeroId1",
                table: "NeteaseHeroStats",
                column: "HeroId1");

            migrationBuilder.CreateIndex(
                name: "IX_NeteaseHeroStats_Source_HeroId_CampId_Season_Part_WeekNum_S~",
                table: "NeteaseHeroStats",
                columns: new[] { "Source", "HeroId", "CampId", "Season", "Part", "WeekNum", "StartDate", "EndDate", "Position" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentApplications_TaskId",
                table: "RecruitmentApplications",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentTasks_EventId",
                table: "RecruitmentTasks",
                column: "EventId");
